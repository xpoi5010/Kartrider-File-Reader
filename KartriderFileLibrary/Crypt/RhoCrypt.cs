...
namespace KartRider.Crypt
{
    ...
    0x0D, 0x06, 0x73, 0xDC
        ...
        public static byte[] DecryptHeader(byte[] data, uint key)
        {
            uint t_key = key;
            uint a = 0;
            List<byte> output = new List<byte>();
        ...
        private static uint GetIV(uint value)
        {
